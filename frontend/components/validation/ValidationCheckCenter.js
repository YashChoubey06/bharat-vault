...
import { validationCheckCenterData } from "@/services/mock/data";
...
export default function ValidationCheckCenter({ parcelId = "PRC-001" }) {
  ...
  // Fetched mock data from @/services/mock/data
  const checksList = validationCheckCenterData || [];
          ...
          <div className={styles.stepGrid}>
            ...
            <div className={styles.stepBox}>
              ...
              <p style={{ fontSize: "12px", color: "#64748b", margin: 0 }}>
                Investigate evidence cross-matches, inspect GIS layer overlays, or record officer findings.
              </p>
