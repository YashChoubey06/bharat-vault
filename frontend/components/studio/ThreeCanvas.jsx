  ...
  useEffect(() => {
    ...
    const customLayer = {
      ...
      onAdd: function (map, gl) {
        ...
        // Full-coverage Cadastral Grid spanning 50,000 meters across the entire map horizon
        const grid = new THREE.GridHelper(50000, 1000, '#0ea5e9', '#64748b');
        grid.position.y = 0.05;
        grid.material.opacity = 0.25;
        grid.material.transparent = true;
        this.scene.add(grid);

        // Endless Parcel footprint ground plane
        const parcelGeo = new THREE.PlaneGeometry(50000, 50000);
        ...
        parcelPlane.position.y = 0.02;
        this.scene.add(parcelPlane);
    ...
    map.on('style.load', () => {
      if (!map.getLayer('3d-cadastral-layer')) {
