...
export default function VerificationDecisionModal({
  ...
  const [selectedDecision, setSelectedDecision] = useState("CORRECT"); // 'CONFIRM', 'CORRECT', 'CUSTOM'
  ...
  function handleSave() {
    ...
    if (
      (selectedDecision === "CORRECT" || selectedDecision === "CUSTOM") &&
      !reason.trim()
    ) {
      ...
      >
        ...
        <div className={styles.modalHeader}>
          <div className={styles.titleGroup}>
            ...
            <p className={styles.subtitle}>Survey 124/2 · Ramesh Kumar</p>
          </div>
        ...
        <div className={styles.modalBody}>
          ...
          <div className={styles.sectionBlock}>
            ...
            <div className={styles.radioOptions}>
              ...
              <label
                className={`${styles.radioCard} ${
                  selectedDecision === "CORRECT" ? styles.radioSelected : ""
                }`}
              >
                <input
                  type="radio"
                  name="modal_decision"
                  checked={selectedDecision === "CORRECT"}
                  onChange={() => setSelectedDecision("CORRECT")}
                />
                Correct to {gisValue} (GIS Surveyed Value)
              </label>
