...
export default function DilrmpProgressCard({ progressData, scopeLabel }) {
  if (!progressData) return <div className={styles.cardContainer}><h2>Digitization & Integration Progress</h2><p>National digitization metrics are unavailable from the local backend.</p></div>;
